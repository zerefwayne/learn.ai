...
var modelJson = JSON.parse(
  '{"model": 2,"layers": [ {"type": "dense","no": 1, "activation": "tanh"},{ "type": "dense", "no": 1, "activation": "sigmoid"}], "parameters": { "optimizer": { "type": "adam", "lr": "0.02" },"loss": "binaryCrossentropy", "epochs": 10}}'
);
